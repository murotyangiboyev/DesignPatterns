...
* **Prototype Interface/Abstract Class:** Defines the clone() method and sets a standard
    for all objects that can be cloned
* **Concrete Prototype** Implements the prototype interface or extends the abstract class
...
## That is the explanation of The Prototype Design Pattern by Murat !